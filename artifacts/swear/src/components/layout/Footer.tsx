      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 bg-card flex items-center justify-center rounded-none text-muted-foreground hover:text-primary hover:bg-white/5 transition-colors" data-testid="social-ig">IG</a>
            <a href="#" className="w-10 h-10 bg-card flex items-center justify-center rounded-none text-muted-foreground hover:text-primary hover:bg-white/5 transition-colors" data-testid="social-tk">TK</a>
            <a href="#" className="w-10 h-10 bg-card flex items-center justify-center rounded-none text-muted-foreground hover:text-primary hover:bg-white/5 transition-colors" data-testid="social-fb">FB</a>
          </div>
        </div>
      </div>
    </footer>
